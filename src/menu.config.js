import { CartIcon, DashboardIcon, OffersIcon, ProductsIcon, UserIcon, WalletIcon, RequestWithDrawalIcon, ReportsIcon } from "./components/Icons";
...
export const menu = [
    ...
    { id: 'MENU_INVENTORY', title: 'inventory', route: config_path.inventory, icon: <ProductsIcon />},
    ...
    { id: 'MENU_DISCOUNT', title: 'discounts', route: config_path.discounts, icon: <WalletIcon />},
    { id: 'MENU_REPORTS', title: 'reports', icon: <ReportsIcon />, sub_menu: true, sub_items: [
        {id: 'MENU_REPORT_1', title: 'reports_customer_revenue_level', route: config_path.report_customer_revenue_level, icon: <WalletIcon />}
    ]},
]
